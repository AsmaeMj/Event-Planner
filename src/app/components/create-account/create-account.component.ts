...
export class CreateAccountComponent implements OnInit {
  ...
  onSubmit() {
    let user = new User(-1,this.firstname.value, this.lastname.value, this.username.value, this.email.value, this.password.value, this.verifyPassword.value, this.bio.value , this.avatar.value,null,null,null);
